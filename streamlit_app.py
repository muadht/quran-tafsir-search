...
def main():
    ...
    **Quran Text (Arabic)** - Digital Khatt Script ([Tarteel Resources](https://qul.tarteel.ai/resources/quran-script/56))
    
    **English Translation** - Saheeh International Translation ([Tarteel](https://qul.tarteel.ai/resources/translation/193) | [Wikipedia](https://en.wikipedia.org/wiki/Sahih_International))
    
    **Arabic Tafseer (Commentary)** - Scholarly Commentary ([Tarteel Resources](https://qul.tarteel.ai/resources/tafsir/23))
